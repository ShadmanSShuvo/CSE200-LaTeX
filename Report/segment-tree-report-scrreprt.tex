\documentclass[11pt,open=any,headings=option]{scrreprt}
...
\setkomafont{section}{\normalfont\sffamily\bfseries\color{deepblue}}
...
\node[segnode] (root) {$[1,8]$\\sum=36};
\node[segnode, below left=of root] (l) {$[1,4]$\\sum=10};
\node[segnode, below right=of root] (r) {$[5,8]$\\sum=26};
\node[segleaf, below left=of l] (a) {$[1,2]$};
\node[segleaf, below right=of l] (b) {$[3,4]$};
\node[segleaf, below left=of r] (c) {$[5,6]$};
\node[segleaf, below right=of r] (d) {$[7,8]$};
...
\node[segnode] (n1) {$[1,8]$};
\node[segnode, below left=of n1] (n2) {$[1,4]$};
\node[segnode, below right=of n1] (n3) {$[5,8]$};
\node[segnode, below left=of n2] (n4) {$[1,2]$};
\node[segnode, below right=of n2] (n5) {$[3,4]$};
\node[segnode, below left=of n3] (n6) {$[5,6]$};
\node[segnode, below right=of n3] (n7) {$[7,8]$};
\node[segleaf, below left=of n4] (a1) {$1$};
\node[segleaf, below right=of n4] (a2) {$2$};
\node[segleaf, below left=of n5] (a3) {$3$};
\node[segleaf, below right=of n5] (a4) {$4$};
\node[segleaf, below left=of n6] (a5) {$5$};
\node[segleaf, below right=of n6] (a6) {$6$};
\node[segleaf, below left=of n7] (a7) {$7$};
\node[segleaf, below right=of n7] (a8) {$8$};
\foreach \a/\b in {n1/n2,n1/n3,n2/n4,n2/n5,n3/n6,n3/n7,n4/a1,n4/a2,n5/a3,n5/a4,n6/a5,n6/a6,n7/a7,n7/a8}{\draw[segedge](\a)--(\b);}
\end{tikzpicture}
